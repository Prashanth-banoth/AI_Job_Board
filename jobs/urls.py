...
from .views import job_list, apply_job, my_applications,submit_application,live_jobs,save_job,my_saved_jobs, create_sample_jobs
...
urlpatterns = [
    ...
    path('create-sample-jobs/',create_sample_jobs,name='create_sample_jobs'),
